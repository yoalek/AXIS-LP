...
const Hero: React.FC = () => {
  return (
    <section className="relative pt-32 pb-20 lg:pt-48 bg-background overflow-hidden text-center">
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        <div className="max-w-4xl mx-auto mb-20">
          <BlurFade delay={0}>
            <UrgencyBadge />
            <h1 className="text-5xl lg:text-[84px] font-extrabold text-foreground leading-[1.02] tracking-tighter mb-8">
              Blindagem de Folha,<br />
              <span className="text-primary italic font-normal">Risco Zero e eSocial 100%.</span>
            </h1>
          </BlurFade>

          <BlurFade delay={0.2}>
            <p className="text-lg lg:text-xl text-muted-foreground font-medium max-w-2xl mx-auto leading-relaxed mb-12">
        ...
        <div className="relative mt-20 max-w-6xl mx-auto">
          <BlurFade delay={0.6} yOffset={40}>
            <div className="relative rounded-[40px] overflow-hidden shadow-[0_50px_100px_-20px_rgba(0,0,0,0.15)] bg-slate-900 aspect-[16/9] lg:aspect-[21/9] border border-border">
              ...
              <div className="absolute top-8 left-8">
                <button className="bg-white/10 backdrop-blur-md border border-white/20 px-6 py-2.5 rounded-full text-[13px] font-bold text-white shadow-lg flex items-center gap-2">
                  Compliance Ativo 24/7
                </button>
              </div>
              <div className="absolute inset-x-0 bottom-10 px-6">
                <div className="flex flex-wrap items-center justify-center gap-4 lg:gap-6 animate-fade-in-up">
                  <ProfileBadge name="Joseane Medeiros" role="Estrategista DP" color="bg-orange-500" initial="JM" />
                  <ProfileBadge name="Equipe Axis" role="Suporte Especializado" color="bg-primary" initial="AX" />
                  <ProfileBadge name="Seu Negócio" role="Crescimento Seguro" color="bg-emerald-500" initial="SN" />
                </div>
              </div>
            </div>
          </BlurFade>
