            ...
            <div className="max-w-7xl mx-auto px-6 h-20 flex flex-row items-center justify-between">
                ...
                <div className="flex items-center gap-6">
                    ...
                    <Button 
                        ...
                        size="icon"
                        onClick={toggleTheme}
                        className="rounded-full shadow-lg hover:shadow-xl transition-all border-border/50 bg-background/50 backdrop-blur-sm"
                    ...
                    <div className="flex items-center">
                        ...
                        <Button 
                            variant="shine" 
                            className="rounded-full px-8 font-black uppercase tracking-wider text-xs shadow-xl shadow-primary/30"
